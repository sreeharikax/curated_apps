...
def curated_setup():
    ...
    utils.run_subprocess(" python3 -m venv my_venv")
    utils.run_subprocess(". my_venv/bin/activate")
    utils.run_subprocess("pip3 install 'docker>=6.1.0' jinja2 tomli tomli-w pyyaml")
